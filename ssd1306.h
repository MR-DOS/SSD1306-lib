...
#define FRAMEBUFFER_SIZE	(SSD1306_COLUMNS*SSD1306_ROWS/8)
	...
	#undef I2C_TIMEOUT
#endif
#define I2C_TIMEOUT 	300000		//I2C timeout for wait loops
...
typedef struct
{
	...
	uint8_t Scroll_Start_Page;
	uint8_t Scroll_Stop_Page;
	uint8_t Scroll_Frameskip;
	uint8_t Scroll_Vertical_Offset;
